...
const SummaryDash = () => {
    ...
    const dataCount = [
        ...
        {id: 3, btnValue: "", name: "My Selected", link: "#", value: <CountUp end={20}/>, icon: <Icons name="book" size="large"></Icons>, style: "text-blue-500"},
        ...
        {id: 5, btnValue: "AllUsers", name: "Users", link: "#", value: <CountUp end={CountUsers}/>, icon: <Icons name="people" size="large"></Icons>, style: "text-blue-500"}, 
