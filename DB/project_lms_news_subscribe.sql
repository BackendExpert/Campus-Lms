...
--
-- Dumping data for table `news_subscribe`
--

LOCK TABLES `news_subscribe` WRITE;
/*!40000 ALTER TABLE `news_subscribe` DISABLE KEYS */;
/*!40000 ALTER TABLE `news_subscribe` ENABLE KEYS */;
UNLOCK TABLES;
