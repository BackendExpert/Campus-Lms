...
const SummaryDash = () => {
    ...
    const dataCount = [
        ...
        {id: 4, name: "Selected Books", link: "#", value: <CountUp end={CountSelectedBooks}/>, icon: <Icons name="book" size="large"></Icons>, style: "text-green-500"},
        {id: 5, name: "Users", link: "#", value: <CountUp end={CountUsers}/>, icon: <Icons name="people" size="large"></Icons>, style: "text-green-500"}, 
